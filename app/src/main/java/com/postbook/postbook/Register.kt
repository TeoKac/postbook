   ...
   fun signInAnonymously(){
        ...
        when(requestCode){
            READIMAGE->{
                if(grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(applicationContext,"Cannot access your images", Toast
                        .LENGTH_LONG).show()
                }
            }
    ...
    fun SaveImageInFirebase(){
        ...
        uploadTask.addOnFailureListener{
            ...
            var DownloadURL = taskSnapshot.uploadSessionUri!!.toString()
            ...
            val url="http://10.0.2.2/projekt/server/register.php?first_name="+ etName.text.toString() + "&email="+ etEmail.text.toString() + "&password="+ etPassword.text.toString() + "&picture_path="+ DownloadURL
